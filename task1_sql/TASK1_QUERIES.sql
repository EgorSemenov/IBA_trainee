...
FROM EMPLOYEE AS E, 
     (SELECT LASTNAME, HIREDATE, E.WORKDEPT as DEP
      FROM EMPLOYEE AS E 
           INNER JOIN DEPARTMENT AS D ON E.WORKDEPT = D.DEPTNO 
      WHERE E.EMPNO = D.MGRNO and E.WORKDEPT = 'A00') AS M
WHERE E.WORKDEPT = 'A00' AND  M.HIREDATE > E.HIREDATE and M.DEP = E.WORKDEPT
ORDER BY E.LASTNAME;
...
FROM EMPLOYEE AS E
     ...
     INNER JOIN EMPLOYEE AS M ON D.MGRNO = M.EMPNO
